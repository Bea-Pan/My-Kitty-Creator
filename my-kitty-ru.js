...
const title = `<h1>Это <span class="word" title="id: kitty-name" style="color:#b9652d; font-weight:bold">${kittyName},</span> котик которого ты создал/создала:`;
